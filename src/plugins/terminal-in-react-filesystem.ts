import { PluginApi, PluginBase } from 'terminal-in-react';

export default class FileSystemPlugin extends PluginBase {
  static displayName = 'FileSystemPlugin';
  static version = '1.0.0';

  commands = {
    cd: () => console.log('testy'),
  };
  descriptions = {
